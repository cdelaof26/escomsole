      ...
      switch (state) {
        ...
        case 13:
          if (Character.isLetterOrDigit(c) || c == '_') { 
            ...
            if (type == TokenType.NONE)
              t = new Token(TokenType.ESC_IDENTIFIER, lexeme, lineNumber, scanIndex - lexeme.length());
            else
        ...
        case 15:
          if (c == '.') {
            ...
            tokens.add(new Token(TokenType.ESC_NUMBER, lexeme, Integer.valueOf(lexeme), lineNumber, scanIndex - lexeme.length()));
            lexeme = "";
            state = 0;
            scanIndex--;
          }
        ...
        case 17:
          if (Character.isDigit(c)) { // state 17
            ...
            tokens.add(new Token(TokenType.ESC_FLOATING_NUMBER, lexeme, Float.valueOf(lexeme), lineNumber, scanIndex - lexeme.length()));
            lexeme = "";
            state = 0;
            scanIndex--;
          }
        ...
        case 20:
          if (Character.isDigit(c)) { // state 20
            ...
            tokens.add(new Token(TokenType.ESC_DOUBLE_NUMBER, lexeme, Double.valueOf(lexeme), lineNumber, scanIndex - lexeme.length()));
            lexeme = "";
            state = 0;
            scanIndex--;
          }
